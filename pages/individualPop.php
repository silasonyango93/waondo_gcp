...
if (isset($_POST['AdmissionNo']) ) {
	...
	/*header("Location:http://34.73.97.17/Waondo/pages/individualFee.php?AdmissionNo=$AdmissionNo");*/
	echo "<script>window.location='http://34.73.97.17/Waondo/pages/individualFee.php?AdmissionNo=$AdmissionNo';</script>";

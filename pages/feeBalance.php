            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
						...
						<li>
                            <a href="http://34.73.97.17/Waondo/pages/updatePhotoPop.php"><i class="fa fa-camera fa-fw"></i> Update Photo</a>
                        </li>
                        
                        <li>
                            <a href="http://34.73.97.17/Waondo/pages/deleteStudentPop.php"><i class="fa fa-trash fa-fw"></i> Remove Student</a>
                        </li>
							
							<li>
                            <a href="http://34.73.97.17/Waondo/pages/sessionManagement.php"><i class="fa fa-power-off fa-fw"></i> Log Out</a>
                        </li>
                            <!-- /.nav-second-level -->
                        </li>
